...
import { insertAvailableSlotSchema, insertDiscountCodeSchema, insertAdminUserSchema } from "@shared/schema";
  ...
  try {
    ...
    if (count === 0) {
      ...
      const insertResult = await pool.query(
        ...
        ['admin', hashedPassword, 'admin@alignwithsoulitude.co.uk', 'Admin', 'User', 'admin', true, new Date()]
      );
...
export function registerAdminRoutes(app: Express) {
  ...
  app.post('/api/admin/resend-confirmation-email', async (req: Request, res: Response) => {
    try {
  ...
  app.get('/api/admin/services', async (_req: Request, res: Response) => {
    try {
  ...
  app.get('/api/admin/slots', async (req: Request, res: Response) => {
    try {
  ...
  app.post('/api/admin/slots/bulk', async (req: Request, res: Response) => {
    try {
  ...
  app.put('/api/admin/slots/:id', async (req: Request, res: Response) => {
    try {
      const id = parseInt(req.params.id);
  ...
  app.get('/api/admin/consultations', async (_req: Request, res: Response) => {
    try {
  ...
  app.put('/api/admin/consultations/:id/status', async (req: Request, res: Response) => {
    try {
      const id = parseInt(req.params.id);
  ...
  app.get('/api/admin/discount-codes', async (_req: Request, res: Response) => {
    try {
  ...
  app.post('/api/admin/discount-codes', async (req: Request, res: Response) => {
    try {
  ...
  app.post('/api/admin/discount-codes-simple', async (req: Request, res: Response) => {
    try {
  ...
  app.put('/api/admin/discount-codes/:id', async (req: Request, res: Response) => {
    try {
      const id = parseInt(req.params.id);
  ...
  app.delete('/api/admin/discount-codes/:id', async (req: Request, res: Response) => {
    try {
      const id = parseInt(req.params.id);
        ...
        if (username === 'admin' && password === 'password') {
          ...
          try {
            ...
            const newUserResult = await pool.query(
              ...
              ['admin', hashedPassword, 'Admin', 'User', 'admin@example.com', 'admin', true, new Date()]
            );
  ...
  app.post('/api/admin/settings/email', async (req: Request, res: Response) => {
    try {
  ...
  app.post('/api/admin/settings/stripe', async (req: Request, res: Response) => {
    try {
