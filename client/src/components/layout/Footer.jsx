    ...
    <footer className="bg-neutral-800 text-white py-12">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-['Playfair_Display'] font-medium mb-4">Align with Soulitude</h3>
          ...
          <div>
            <h3 className="text-lg font-medium mb-4 font-['Raleway']">Newsletter</h3>
            <p className="text-neutral-400 mb-4 font-['Raleway']">
              Subscribe to our newsletter for mindfulness tips, event updates, and special offers.
            </p>
